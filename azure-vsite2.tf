module "vsite2" {
  source                    = "./vsite"
  f5xc_vsite_name           = format("%s-azure-vsite-2", var.project_prefix)
  ...
  vnet_cidr_block           = "10.2.0.0/16"
  azure_availability_zones  = [ "1", "2" ]
  azure_slo_subnets         = [ "10.2.1.0/24" ]
  azure_sli_subnets         = [ "10.2.11.0/24" ]
  azure_sli_workload_ip     = [ "10.2.11.100", "10.2.11.101" ]
